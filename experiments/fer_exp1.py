...
optims = [
    optimizers.Adam(learning_rate=0.0005, beta_1=0.9, beta_2=0.999, epsilon=1e-07, name='Adam'),
    optimizers.Adam(0.0005),
]
...
#saving model
model.save("drive/MyDrive/fer_models/fer_gpu3/fer_model_cnn_2.h5")
...
pyplot.savefig('drive/MyDrive/fer_models/fer_gpu3/epoch_history_dcnn_2.png')
pyplot.show()
...
pyplot.savefig('drive/MyDrive/fer_models/fer_gpu3/performance_dist_2.png')
pyplot.show()
...
pyplot.savefig("drive/MyDrive/fer_models/fer_gpu3/confusion_matrix_dcnn_2.png")
